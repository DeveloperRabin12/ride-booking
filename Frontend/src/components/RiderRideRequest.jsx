...
const RiderRideRequest = ({ rideData, onAccept, onReject }) => {
  return (
    <div className="h-full flex flex-col items-center justify-center bg-blue-50 p-6">
      <div className="text-center max-w-md">
        <h3 className='text-3xl font-bold mb-6 text-blue-800'>🚗 New Ride Request</h3>
        
        {/* User Info */}
        <div className='flex items-center justify-between p-3 bg-blue-100 rounded-lg mt-4 mb-6'>
          <div className='flex items-center gap-3'>
            ...
            />
            <div>
              <h2 className='text-xl font-medium text-gray-800'>{rideData?.user?.name || 'Unknown User'}</h2>
...
export default RiderRideRequest
